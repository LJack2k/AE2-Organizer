...
public final class Ae2Style {
    ...
    /** Renders an item icon scaled to {@code size} pixels (vanilla item render is fixed 16px). */
    public static void scaledItem(GuiGraphicsExtractor graphics, net.minecraft.world.item.ItemStack stack, int x, int y, int size) {
