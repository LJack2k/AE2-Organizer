...
public final class TabShare {
     ...
     * TerminalOrganizer tab export (so import can fail gracefully). Imported tabs keep
    ...
    /** Parse a full export. Empty if the text isn't an TerminalOrganizer windows export. */
